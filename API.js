...
// API link format is "[server]/latest?pollutant=[pollutant]&unit=[unit]". ex: http://localhost:8080/interpolatedMap?pollutant=pm2.5&unit=ug/m3
// Parameters: Use BC for Black Carbon
// Units: Use ug/m3 for µg/m³, p/cm3 for particles/cm³, and ppm or ppb for those.
app.get("/interpolatedMap", async (req, res) => {
  ...
  try {
      ...
      if (!results)
        ...
        //var variogram = kriging.train(t,x,y,"gaussian", 0.02, 30);
